    ...
    <div className="min-h-screen bg-[#07060b] flex items-center justify-center px-4 py-12 animate-fade-in">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card border border-white/10 rounded-2xl p-8">
          <div className="mb-6">
            <div className="text-[11px] uppercase tracking-[0.18em] text-[color:var(--muted)] mb-1">Registration</div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-[11px] uppercase tracking-[0.12em] text-[color:var(--muted)] mb-2">Confirm password</label>
              <input
                type="password"
                required
                value={confirm}
            ...
            {success && (
              <p className="text-[12px] text-emerald-400 border border-emerald-500/20 bg-emerald-500/[0.06] rounded-xl px-4 py-3">{success}</p>
            )}
          ...
          <div className="mt-6 pt-6 border-t border-white/[0.06] text-center">
            ...
            <Link href="/login" className="text-[12px] text-white hover:text-[color:var(--gold)] transition">Sign in</Link>
          </div>
        </div>
      </div>
    </div>
