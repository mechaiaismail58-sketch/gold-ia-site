  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="flex-1 overflow-hidden">
        <iframe
          src="https://s.tradingview.com/widgetembed/?symbol=OANDA:XAUUSD&interval=60&theme=dark&style=1&locale=en&hide_top_toolbar=0&hide_side_toolbar=0&allow_symbol_change=0"
          width="100%"
          height="100%"
