          ...
          {INTERVALS.map((tf) => {
            ...
            return (
              <button
                ...
                className={
                  active
                    ? "rounded-xl px-3 py-2 text-xs font-mono uppercase tracking-[0.08em] text-[#D4A843] bg-[#D4A843]/[0.1] border border-[#D4A843]/40"
                    : "rounded-xl px-3 py-2 text-xs uppercase tracking-[0.08em] text-white/60 bg-white/[0.03] border border-white/[0.06] transition-colors hover:border-white/20 hover:text-white"
                }
              >
                {tf.label}
              </button>
