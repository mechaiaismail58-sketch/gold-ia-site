          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0">
                {[0, 1, 2, 3, 4].map((i) => (
                  <div key={i} className="absolute top-1/2 left-1/2 hero-particle-orbit" style={{ width: "4px", height: "4px", marginLeft: "-2px", marginTop: "-2px", animationDelay: `${i * -3}s` }}>
                    <span className="block rounded-full hero-particle-pulse" style={{ width: i % 2 === 0 ? "3px" : "2px", height: i % 2 === 0 ? "3px" : "2px", background: i % 2 === 0 ? "#D4A843" : "#9B7DE8", boxShadow: i % 2 === 0 ? "0 0 6px rgba(212,168,67,0.6)" : "0 0 6px rgba(123,79,212,0.5)", animationDelay: `${i * -1.2}s` }} />
                  </div>
                ))}
              </div>
              <div className="relative flex items-center justify-center rounded-full hero-core-breathe" style={{ width: "52px", height: "52px", background: "radial-gradient(circle at 35% 35%, rgba(123,79,212,0.12), rgba(212,168,67,0.06) 60%, rgba(0,0,0,0.2))", border: "1px solid rgba(212,168,67,0.15)", boxShadow: "0 0 40px rgba(123,79,212,0.1), 0 0 15px rgba(212,168,67,0.08), inset 0 1px 1px rgba(255,255,255,0.06)", backdropFilter: "blur(8px)" }}>
                <div className="rounded-full hero-spark" style={{ width: "8px", height: "8px", background: "radial-gradient(circle, #F5DFA0, #D4A843)", boxShadow: "0 0 12px rgba(212,168,67,0.6), 0 0 30px rgba(212,168,67,0.2)" }} />
              </div>
            </motion.div>
